...
> Source: [wind8ai harness list](https://github.com/stars/wind8ai/lists/harness) · Updated: 2026-07-03
...
- [claude-code](#5-anthropicsclaude-code-136k-) — Claude Code is an agentic coding tool running in your termin…
...
- [OpenHarness](#26-hkudsopenharness-14k-) — "OpenHarness: Open Agent Harness with a Built-in Personal Ag…
- [claude-code-book](#37-lintsinghuaclaude-code-book-38k-) — 《御舆：解码 Agent Harness》42万字拆解 AI Agent 的Harness骨架与神经 —— Claude…

### 🔀 Multi-Agent Orchestration

- [hermes-agent](#3-nousresearchhermes-agent-208k-) — An Agent that grows with you
- [agency-agents](#6-msitarzewskiagency-agents-126k-) — A complete AI agency at your fingertips
- [deer-flow](#9-bytedancedeer-flow-76k-) — Open-source long-horizon SuperAgent harness for research, co…
- [oh-my-openagent](#12-code-yeongyuoh-my-openagent-65k-) — omo: the best Agent Harness (formerly oh-my-opencode)
...
- [evolver](#32-evomapevolver-88k-) — The GEP-powered self-evolving engine for AI agents
- [autoagent](#36-kevinrguautoagent-45k-) — autonomous harness engineering
- [mercury-agent](#39-cosmicstack-labsmercury-agent-28k-) — Soul-driven AI agent with permission-hardened tools, token b…
- [harness-books](#40-wquguruharness-books-26k-) — 📚 Two books on harness engineering — the design philosophies…
- [SkillClaw](#41-amap-mlskillclaw-2k-) — Let Skills Evolve Collectively with Agentic Evolver
...
- [Trellis](#29-mindfold-aitrellis-12k-) — The best agent harness
- [gsd-core](#33-open-gsdgsd-core-58k-) — Git
...
- [agents.md](#24-agentsmdagents.md-23k-) — AGENTS
- [cc-connect](#27-chenhg5cc-connect-13k-) — Bridge local AI coding agents (Claude Code, Cursor, Gemini C…
...
- [claude-code-book](#37-lintsinghuaclaude-code-book-38k-) — 《御舆：解码 Agent Harness》42万字拆解 AI Agent 的Harness骨架与神经 —— Claude…
- [MonkeyCode](#38-chaitinmonkeycode-35k-) — Enterprise Online AI Coding Platform
