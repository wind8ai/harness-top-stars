...
## 19. harness/harness (36k ⭐)

**🔗** https://github.com/harness/harness  
**🍴** Fork 3.2k | **🔄** Updated 2026-06-02  
...
## 20. Yeachan-Heo/oh-my-claudecode (36k ⭐)

**🔗** https://github.com/Yeachan-Heo/oh-my-claudecode  
**🍴** Fork 3.3k | **🔄** Updated 2026-06-03  
...
### 来源
- 仅收录 wind8ai GitHub Stars 中标记为 `Harness` 列表的仓库
- 地址：https://github.com/stars/wind8ai/lists/harness
- **注意**：列表有分页，必须翻完所有页
...
### 剔除规则
- 剔除某个项目时在对应条目**标题**旁注明 `❌ [YYYY-MM-DD] 原因`
